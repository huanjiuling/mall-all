...
public class DataInitController {
    ...
    public void batchLoginIn() throws SQLException, InterruptedException {
        ...
        String selectUserInfo = "select username,password from ums_member where username like 'huan%'";
